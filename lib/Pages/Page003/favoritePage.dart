...
class FavItemPage extends StatefulWidget {

  final bool isFav; 

  FavItemPage(this.isFav);
  
  FavItemPageState createState() => FavItemPageState();
}

class FavItemPageState extends State<FavItemPage> with SingleTickerProviderStateMixin {
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: Row(
                              children: [
                                (selectedItemList.favItemItemList.item.length == 1) ? Container() : DropdownButton<Item>(
                                  isExpanded: false,
                                  value: itemShowing,
                                  style: TextStyle(
                                  ...
                                  items: selectedItemList.favItemItemList.item.map((Item item) {
                                  ...
                                  onChanged: (Item newItem) {
                                    selectedItemList.setFavListSelectedItem = newItem;
                                  },
                                ),
